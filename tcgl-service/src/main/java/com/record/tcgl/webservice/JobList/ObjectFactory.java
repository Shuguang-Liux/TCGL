 ...
 * generated in the com.record.tcgl package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetUserInfo_QNAME = new QName("http://webservice.tcgl.record.com", "getUserInfo");
    private final static QName _GetUserInfoResponse_QNAME = new QName("http://webservice.tcgl.record.com", "getUserInfoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.record.tcgl
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.tcgl.record.com", name = "getUserInfo")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.tcgl.record.com", name = "getUserInfoResponse")
