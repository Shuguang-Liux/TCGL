package com.record.tcgl.security.utils;
...
public class JWTTokenUtils {
	...
	public void init() {
		jwtTokenUtils = this;
		jwtTokenUtils.loadUserService = this.loadUserService;
	}
	...
	public static String refreshAccessToken(String oldToken) {
		...
		SysUserDetails sysUserDetails = (SysUserDetails) jwtTokenUtils.loadUserService
	...
	public static SysUserDetails parseAccessToken(String token) {
		...
		if (StringUtils.isNotEmpty(token)) {
			try {
				...
				sysUserDetails.setId((int) Long.parseLong(claims.getId()));
